...
console.log(pizzaBarata?"Si hay pizza de valor menor a 600":"No tenemos ninguna pizza a ese precio")
...
//d)
const ingredientes = pizzas.map(pizza => pizza.ingredientes)
ingredientes.forEach(ingrediente => console.log(ingrediente.join(","))) 
